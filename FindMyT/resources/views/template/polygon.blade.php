...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            ...
            <!-- End Navbar -->
            <div id="map" style="width: parent; height: parent;"></div>
            <footer class="footer">
                <div class="container-fluid">
                    <nav>
                        ...
                        <p class="copyright text-center">
                            ...
                            <a href="">Jagures code</a> Instituto Tecnológico Superior de Cuidad Hidalgo
                        </p>
                    </nav>
                </div>
            </footer>
...
<script type="text/javascript">
    function turnNegative(){
        return Math.ceil(Math.random() * 10) % 2 == 0 ? -1 : 1;
    }
    var locations = [];
    for(var i = 1; i <= 10; i++){
        locations.push(["Localizacion "+i, (Math.random()*100)*turnNegative(), (Math.random()*100)*turnNegative(), i]);
    }
