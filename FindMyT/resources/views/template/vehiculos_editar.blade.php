        ...
        <div class="main-panel">
           ...
           <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            ...
            <div style="width: 70%; margin: auto; padding: 30px;">
                <form action="{{ route('vehiculos.actualizar') }}" method="post">
                    @csrf
                    ...
                    <label for="marca">Marca</label>
                        <input name="marca" type="text" class="form-control" id="marca" placeholder="Marca" required value="{{ $vehiculo->marca }}">
                    </div>
                    <div class="form-group">
                    <label for="modelo">Modelo</label>
                        <input name="modelo" type="text" class="form-control" id="canal" placeholder="Modelo" required value="{{ $vehiculo->modelo }}">
                    </div>
                    <div class="form-group">
                    <label for="fabricante">Fabricante</label>
                        <input name="fabricante" type="text" class="form-control" id="canal" placeholder="Fabricante" required value="{{ $vehiculo->fabricante }}">
                    </div>
                    <div class="form-group">
                    <label for="color">Color</label>
                        <input name="color" type="text" class="form-control" id="canal" placeholder="Color" required value="{{ $vehiculo->color }}">
                    </div>
                    <div class="form-group">
                    <label for="no_placas">No Placas</label>
                        <input name="no_placas" type="text" class="form-control" id="canal" placeholder="No de placas" required value="{{ $vehiculo->no_placas }}">
                    </div>
                    <div class="form-group">
                    <label for="anio">Año</label>
                        <input name="anio" type="text" class="form-control" id="canal" placeholder="Año" required value="{{ $vehiculo->anio }}">
                    </div>
